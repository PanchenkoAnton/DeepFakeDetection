...
class Block(nn.Module):
    def __init__(self,
        ...
        if strides != 1 or out_filters != in_filters:
        ...
        if grow_first:
            ...
            rep.append(SeparableConv2d(in_filters,
                                       out_filters,
                                       3,
                                       stride=1,
                                       padding=1,
        ...
        for i in range(reps - 1):
            rep.append(nn.ReLU(inplace=True))
            rep.append(SeparableConv2d(filters,
                                       filters,
                                       3,
                                       stride=1,
                                       padding=1,
...
class Xception(nn.Module):
    ...
    Implemented as specified in https://arxiv.org/pdf/1610.02357.pdf.
    """
...
def xception(num_classes=1000, pretrained='imagenet'):
    ...
    if pretrained:
        ...
        assert num_classes == settings['num_classes'], \
            "num_classes should be {}, but actually it's {}".format(
